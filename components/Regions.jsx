...
const regions = [
    {
        ...
        "img": "https://assets.vogue.com/photos/6352ccb841ea2bd565be085f/master/w_2560%2Cc_limit/GettyImages-1223580360.jpg",
        link: '/regions/north'
    ...
    },
    {
        ...
        "img": "https://i0.wp.com/swadishta.de/wp-content/uploads/2021/01/Idle.jpg",
        link: '/regions/south'
    ...
    },
    {
        ...
        "img": "https://ngs-space1.sgp1.digitaloceanspaces.com/am/uploads/mediaGallery/image/1681669088131.jpg-org",
        link: '/regions/east'
    ...
    },
    {
        ...
        "img": "https://miro.medium.com/v2/resize:fit:1200/1*UegPuEE-nV5Nv_M734AVng.jpeg",
        link: '/regions/west'
                ...
                <div className='grid grid-cols-2 w-[50rem] my-10 mx-auto items-center gap-10'>
                    {
                        regions.map((item, idx) => {
                            return <div className="card rounded-2xl overflow-hidden w-96 bg-base-100 shadow-xl image-full mx-auto" key={idx}>
                                <figure className='blur-[3px]'><img src={item.img} alt="Shoes" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">{item.title}</h2>
                                    <p>{item.content}</p>
                                    <div className="card-actions justify-end">
                                        <Link href={item.link} className="btn btn-primary">Learn More</Link>
                                    </div>
                                </div>
                            </div>
                        })
